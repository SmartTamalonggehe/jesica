...
/***/ "./resources/js/components/valid_koordinat.js":
/*!****************************************************!*\
  !*** ./resources/js/components/valid_koordinat.js ***!
  \****************************************************/
...
var koordinatValid = function koordinatValid() {
  if (list_koordinat) {
    var longitude = document.getElementById("longitude");
    var latitude = document.getElementById("latitude");
    var longitude_value = longitude.value;
    var latitude_value = latitude.value; // check if longitude is decimal number or not (ex: -140.23456789)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (koordinatValid);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_valid_koordinat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../components/valid_koordinat */ "./resources/js/components/valid_koordinat.js");
var tools = __webpack_require__(/*! ./tools */ "./resources/js/my_crud/tools.js");
...
function formBiasa() {
  $("#formKu").on("submit", function (e) {
    e.preventDefault();
    var cekValid = (0,_components_valid_koordinat__WEBPACK_IMPORTED_MODULE_0__["default"])();
    ...
    axios({
      ...
      var backgroundColor = response.data.type === "error" ? "red" : "linear-gradient(to right, #00b09b, #96c93d)";
      Toastify({
        text: "".concat(response.data.pesan),
        duration: 3000,
        close: true,
        gravity: "top",
        position: "right",
      ...
      refresh ? refresh.click() : ""; // reset form
