  ...
  sweetalert__WEBPACK_IMPORTED_MODULE_2___default()({
    ...
    if (willDelete) {
      axios__WEBPACK_IMPORTED_MODULE_0___default()({
        method: "delete",
        url: "/crud/".concat(_tools__WEBPACK_IMPORTED_MODULE_1__.route, "/").concat(href)
...
console.log("route", _tools__WEBPACK_IMPORTED_MODULE_1__.route);
...
document.getElementById("formKu").addEventListener("submit", function (e) {
  e.preventDefault();
  var formData = new FormData(this); // get data from form
  ...
  if (_tools__WEBPACK_IMPORTED_MODULE_1__.save_method === "tambah") {
    method = "post";
    url = "/crud/".concat(_tools__WEBPACK_IMPORTED_MODULE_1__.route);
  } else {
    method = "put";
    url = "/crud/".concat(_tools__WEBPACK_IMPORTED_MODULE_1__.route, "/").concat(data.id);
  }
...
$(document).on("click", ".btn-ubah", function (e) {
  ...
  axios({
    method: "get",
    url: "/crud/".concat(_tools__WEBPACK_IMPORTED_MODULE_0__.route, "/").concat(href, "/edit")
  }).then(function (response) {
    // show modal
    $(".tampilModal").modal("show"); // set save_method
...
var formData = function formData(data) {
  if (_tools__WEBPACK_IMPORTED_MODULE_0__.route == "tutupan") {
