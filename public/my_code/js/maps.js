...
var getDataPolygon = function getDataPolygon() {
  return axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/polygon").then(function (res) {
    return res.data;
  })["catch"](function (err) {
    console.log(err);
  });
...
_init__WEBPACK_IMPORTED_MODULE_0__["default"].on("click", "area-layer", function (e) {
  var show = e.features[0].properties;
  console.log(show); // if (tools.route == "batu_gamping") {
