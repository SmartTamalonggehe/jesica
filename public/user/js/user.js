...
var kawasan = document.getElementById("kawasan");
var menu_kawasan = document.getElementById("menu-kawasan");
var menu_navbar = document.getElementById("menu-navbar");

var menuKawasan = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var polygon, grouped, groupedArr, isiMenu, my_click, i;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            // convert and group
            grouped = polygon.map(function (item) {
            ...
            my_click = document.getElementsByClassName("my-click");

            for (i = 0; i < my_click.length; i++) {
              my_click[i].addEventListener("click", function () {
                var dataAtribut = this.dataset.array; // access data-array

                var arrDataAtribut = JSON.parse(dataAtribut);
                window.location.href = "/kawasan?koordinat_id=[".concat(arrDataAtribut, "]");
              });
            }
...
if (menu_navbar) {
  menuKawasan();
  menu_kawasan.addEventListener("click", function (event) {
    var grandParent = event.target.parentNode;
    var menu = grandParent.querySelector(".my-menu");
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _users_navbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users/navbar */ "./resources/js/users/navbar.js");
