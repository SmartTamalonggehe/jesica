...
const App = (function () {
    ...
    const detectOS = function () {
        ...
        windowsPlatforms.indexOf(platform) != -1 &&
            $("body").addClass(customScrollbarsClass);
    };
    ...
    const sidebarSecondaryToggle = function () {
        ...
        sidebarSecondaryMobileToggler.on("click", function (e) {
            ...
            sidebarSecondaryRestElements.removeClass(
                sidebarMobileExpandedClass
            );
        });
    };
    ...
    const navigationSidebar = function () {
        ...
        $("." + navClass + ":not(." + navScrollSpyClass + ")").each(
            function () {
                $(this)
                    .find("." + navItemClass)
                    .has("." + navSubmenuClass)
                    ...
                    .on("click", function (e) {
                        ...
                        // Accordion
                        if (
                            $target.parents("." + navClass).data("nav-type") ==
                            "accordion"
                        ) {
                            $target
                                .parent("." + navItemClass)
    ...
    const cardActionFullscreen = function () {
        ...
        $(buttonElement).on("click", function (e) {
            ...
            if (!cardFullscreen.hasClass(cardFullscreenClass)) {
                ...
                $("." + scrollableContainerClass).removeClass(
                    "overflow-hidden"
                );
                button
    ...
    const componentHeaderElements = function () {
        ...
        $(".header-elements-toggle").on("click", function (e) {
            ...
            $(this)
                .parents(
                    "[class*=header-elements-]:not(.header-elements-toggle)"
                )
